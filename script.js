...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=oSBWZ_bOr2o",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "AGROVANT TRACTORES Y MAQUINARIA redefine la tecnificación y el rendimiento en el campo, ofreciendo tractores de alta potencia, implementos de máxima durabilidad para condiciones exigentes, tecnología de precisión y un respaldo postventa total que garantiza la rentabilidad de cada ciclo agrícola." },
cat2: { t: "EXCELENCIA", c: "Explora nuestra gama de soluciones integrales: Venta de tractores agrícolas, cosechadoras, implementos de preparación de suelo y siembra, planes de financiamiento y crédito refaccionario a tu medida, demos en parcela, taller especializado y venta de refacciones originales." },
cat3: { t: "CLIENTES FELICES", c: "Nuestra prioridad es mantener tus equipos operando al máximo durante las temporadas clave. Productores, ranchos y agroindustrias de la región respaldan la fuerza, el rendimiento y el soporte operativo excepcional que solo AGROVANT TRACTORES Y MAQUINARIA puede ofrecer." }
    },
    sucursales: {
        suc1: { nombre: "Asesor 1", wa: "5214491472336", maps: "https://maps.app.goo.gl/RCnMaFC6yBCkqHjv9", esp: "Especialista en Tractores Medianos", img: "assets/brand/ASESOR1.jpg" },
        suc2: { nombre: "Asesor 2", wa: "5214491472336", maps: "https://maps.app.goo.gl/RCnMaFC6yBCkqHjv9", esp: "Especialista en Tractores de Alta Potencia", img: "assets/brand/ASESOR2.jpg" },
        suc3: { nombre: "Asesor 3", wa: "5214491472336", maps: "https://maps.app.goo.gl/RCnMaFC6yBCkqHjv9", esp: "Especialista en Cosechadoras y Trilladoras", img: "assets/brand/ASESOR3.jpg" },
        suc4: { nombre: "Asesor 4", wa: "5214491472336", maps: "https://maps.app.goo.gl/RCnMaFC6yBCkqHjv9", esp: "Especialista en Implementos y Sembradoras", img: "assets/brand/ASESOR4.jpg" },
        suc5: { nombre: "Asesor 5", wa: "5214491472336", maps: "https://maps.app.goo.gl/RCnMaFC6yBCkqHjv9", esp: "Especialista en Financiamiento y Crédito Agrícola", img: "assets/brand/ASESOR5.jpg" },
        suc6: { nombre: "Asesor 6", wa: "5214491472336", maps: "https://maps.app.goo.gl/RCnMaFC6yBCkqHjv9", esp: "Especialista en Paquetes de Rancho y Refacciones", img: "assets/brand/ASESOR6.jpg" }
    }
};
